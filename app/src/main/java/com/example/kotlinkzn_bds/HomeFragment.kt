...
class HomeFragment : Fragment() {
    ...
    private fun init(view: View) {
        ...
        shoppingRecycler.layoutManager =
            LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false)
        ...
        eventButton.setOnClickListener {
            ...
            Handler().postDelayed({
                listener?.changeNavBarColors(
                    ...
                    listener?.eventIcon ?: ImageView(context),
                    listener?.eventText ?: TextView(context),
                    listener?.eventUnderline ?: ImageView(context)
                )
        ...
        shoppingButton.setOnClickListener {
            ...
            Handler().postDelayed({
                listener?.changeNavBarColors(
                    ...
                    listener?.shoppingIcon ?: ImageView(context),
                    listener?.shoppingText ?: TextView(context),
                    listener?.shoppingUnderline ?: ImageView(context)
                )
    ...
    interface FragmentInteractionListener {
        ...
        // Add any other variables you need for communication between fragments and activity
